...
} = require("./newLogin/phoneLogin/verify_phone_otp_controller");

const {
  forget_password_controller,
} = require("./forgetPass/forget_password.controller");

const {
  verify_forget_otp_controller,
} = require("./forgetPass/verify_forget_otp.controller");

const {
  reset_password_controller,
} = require("./forgetPass/reset_password.controller");
